...
@NgModule({
  declarations: [
    ...
    TableRowDirective,
    ClipboardComponent,
    DropdownComponent, ClickOutsideDirective, ProjectionsComponent, TableHeaderComponent, TableRowComponent, ClipboardComponent, AccountLookupComponent, LabelComponent, ChartsComponent],
  imports: [
    FontAwesomeModule,
    CommonModule,
    FormsModule,
